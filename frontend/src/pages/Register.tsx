    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
          {step === 1 ? 'Start managing your expenses today' : `Enter the 6-digit code sent to ${email}`}
        </p>
      </div>
      ...
      <div className="glass-panel" style={{
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleVerifyOTP}>
            <div className="form-group" style={{ marginBottom: '2.5rem' }}>
              <label className="form-label" style={{ fontWeight: 600, color: 'var(--text-primary)', marginBottom: '0.75rem', textAlign: 'center', display: 'block' }}>
                Verification Code
              </label>
              <input 
                type="text" 
            ...
            <button type="button" onClick={() => setStep(1)} disabled={isSubmitting} style={{
              width: '100%',
              padding: '1rem',
